...
common = dict(CFBundleDevelopmentRegion='en_GB', CFBundleShortVersionString='0.1.0', CFBundleVersion='3', LSMinimumSystemVersion='14.0', CFBundleSupportedPlatforms=['MacOSX'])
