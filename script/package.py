...
common = dict(CFBundleDevelopmentRegion='en_GB', CFBundleShortVersionString='0.1.0', CFBundleVersion='5', LSMinimumSystemVersion='14.0', CFBundleSupportedPlatforms=['MacOSX'])
app_info = dict(common, CFBundleName='rmconvert', CFBundleDisplayName='rmconvert', CFBundleIdentifier='com.robertsmacros.rmconvert', CFBundleExecutable='RMConvertApp', CFBundlePackageType='APPL', NSPrincipalClass='NSApplication', NSHighResolutionCapable=True, NSHumanReadableCopyright='Roberts Macros · no macro too micro')
